    ...
    <template v-if="showSite">
      <v-app id="app">
        <v-dialog v-model="show_cart">
          <div
            style="background-color: var(--color-bg); width: 100%; position:relative;"
            class="pb-1 pt-1"
          >
            <div
              style="display: flex; justify-content: flex-end; position: absolute; width: 100%"
              class="pr-2"
            >
              <v-spacer />
              <v-btn
            ...
            >
              <div style="display: flex; flex-wrap: wrap;">
                <div style="width: 100%; margin-top: -10px; margin-bottom: 10px;">
                  ...
                  <img
                    src="./assets/images/content/ServiceDogStandardsFooterAsset25.svg"
