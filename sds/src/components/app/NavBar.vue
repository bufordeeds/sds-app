...
<!--     </v-menu>-->
     ...
     >
        ...
        <img
            src="../../assets/images/logo/SDSLogoWITHOVALL.svg"
             height="65px"
             @click="$router.push('/')"
        ...
        <v-btn text  large color="white" @click="click_learn_more()" ref="btn_learn_more" v-if="!isAdmin">
           Learn More
        </v-btn>
...
<!--          "-->
           <v-card   v-if="!$auth.authenticated ">
              <login @logged-in="on_login"></login>
           </v-card>

           <v-card v-else class="pa-2" >

              <div  style="display: flex; justify-content: flex-end;" >
                 <v-btn text @click="$auth.logout()" style="padding-right: 5px">
                    Log Out
       ...
       <v-btn icon large  @click="go_to_cart" v-if="!isAdmin" class="mr-2">
    ...
    >
      <a href="/">
        ...
        <img v-if="$vuetify.breakpoint.width > 360"
            src="../../assets/images/logo/service-dog-standards.png" height="40px">
      ...
      <v-spacer></v-spacer>
       ...
       <!------------shopping cart-------------------------------------->
       <v-btn icon large  @click="go_to_cart" v-if="!isAdmin">
          <div style="display: flex; flex-direction: row; ">
             <!--                    <v-icon color="white">shopping_cart</v-icon>-->
       ...
       >
          <template v-slot:activator="{ on }">
             <v-btn text  small v-on="on" key="menu-learn-more">
       ...
       >
          ...
          <v-card class="pa-6">
             <div style="width: 100%; display: flex; justify-content: flex-start" class="mt-2">
                <img src="../../assets/images/icons/menu_icons_arrow.png" height="30px"
                     style="margin-top: 5px">
                <div @click="show_learn_more=true" :dark="dark" color="black" class="pl-2">
             ...
             <div
                 v-for="(item, i) in items" :key="item.url"
             ...
             >
                ...
                <router-link :to="item.url" @click="show_learn_more=true" :dark="dark" color="black" class="pl-2">
                   <div class="mobile-menu-h1">
                      {{item.h1}}
                   </div>
                   <div class="mobile-menu-h2">
             ...
             >
                <div style="width: 100%; display: flex; justify-content: flex-start; margin-left: 40px" class="pt-3">
                   ...
                   <router-link :to="item.path" style="color:black">{{ item.title }}</router-link>
                </div>
             </div>
