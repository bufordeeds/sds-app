<template>
   <div class="pa-6 pt-0" style="background-color: white; display: flex; flex-wrap: wrap">

      <div class="menu-col mr-6 mt-4">
         <div>
            ...
            <div class="menu-links">
               <router-link to="/learn-more/mission">What is our mission, purpose and focus?</router-link> <br>
               <router-link to="/learn-more/what-is-service-animal">
               ...
               <!--<router-link to="/downloads/Service_Dog_Standards_Training_and_Behavior_Standards_SDSTBS-21.pdf">-->
