...
<div style="width: 100%; background-color: var(--color-bg)">
   ...
   <v-carousel
       hide-delimiters height="60vh" v-model="ix"
       style="background-color: white; margin-bottom: 10px"
   >

      <div class="more-menu" v-if="edit_mode">

         <v-btn icon large color="red" @click="show_delete_confirm=true">
   ...
   <v-row>
      <v-row dense style="width: 100%; " justify="center" class="pt-1 pb-1 mb-4">
         <v-col
