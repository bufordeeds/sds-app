<template>
   <div>
      ...
      <div class="content-container-bg">
         <div class="content-container-sm" v-if="sent !== true">
...
<!--                      ></textarea>-->
               ...
               <v-row class="ma-0">
                 <div v-if="err_msg" style="color: red">
                   {{err_msg}}
                 </div>
                  <v-spacer/>
                  <v-btn  @click="on_submit" :loading="loading">
                    Submit
                  </v-btn>
               </v-row>
            </my-form>
        ...
        <div class="content-container-sm" v-if="sent === true" style="text-align: center; font-size: 14pt; padding-top: 20px">
      ...
      return {
        ...
        err_msg: null,
         ...
         type_list: [
            ...
            {txt: 'Friend/Family of Service Dog Owner', val: 'Friend of Service Dog Owner'},
            {txt: 'Breeder/Trainer/Shelter', val: 'Breeder/Trainer/Shelter'},
            {txt: 'Press', val: 'Press'},
            {txt: 'Other', val: 'Other'},
         ]
      }
   ...
   methods: {
      async on_submit(){
         try{
           ...
           console.log('debug')
           this.loading = true;
           await this.make_request('/public/sendContactUs', {message: this.msg, api_key: 'ac9283787032ec04997db9eb2c4f3f3b'})
           this.loading = false;
           this.sent = true;
