      ...
      <div data-v-3dd2e005="" class="section-inner-container">
        ...
        <div data-v-3dd2e005="" class="row">
          <div data-v-3dd2e005="" class="col-md-8 col-12">
            ...
            <ul v-html="section_02_list" class="bullet_check"></ul>
        ...
        <div data-v-3dd2e005="" class="row">
          <div data-v-3dd2e005="" class="col-12">
            <section>
              ...
              <iframe width="560" height="315" src="https://www.youtube.com/embed/WyKld0UXjcY?si=qRmpL8_ZL92OJyis"
                title="YouTube video player" frameborder="0"
                allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            </section>
  ...
  export default {
    ...
    data() {
      return {
        ...
        page_list: '<li class="text-bold">Service dogs must be allowed in most business areas.</li><li class="text-bold">Businesses can confirm legitimacy with 2 questions: disability need and trained task.</li><li class="text-bold">Not all disabilities are visible.</li><li class="text-bold">Businesses can remove disruptive animals, but must offer alternative service.</li><li class="text-bold">Train staff to recognize service animals and be friendly to all customers.</li>',
        ...
        section_02_body_01: '<section class="pb-8"><h4 class="copy-title pb-4">Definition</h4><p class="small-content">A service animal is a dog, specifically trained to do work or perform tasks for a person with a disability. These tasks are directly related to the person\'s specific disability and may include',
        section_02_list: "<li><b>Mobility assistance:</b> Guiding someone who is visually impaired, providing balance and support for someone with mobility issues, or retrieving dropped items.</li><li><b>Alerting tasks:</b> Signaling when a diabetic\'s blood sugar drops, alerting someone with a hearing impairment to sounds like alarms or doorbells, or providing warnings for someone with seizures.</li><li><b>Mental health support:</b> Providing emotional support or mitigating the effects of anxiety or panic attacks.</li>",
