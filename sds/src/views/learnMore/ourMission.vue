  ...
  <div>
    ...
    >
      <div class="content-container-sm">
        ...
        <div class=" lm-title">
          What is our mission, purpose and focus?
        </div>
      </div>
      ...
      <!--<img src="./images/dog-computer.jpg" width="100%">-->

      <div style="padding-left: 20px; padding-right: 20px; display: flex; justify-content: center">
        <div class="content-container-sm pt-4">
          <div class="section">
            We were designed with input from hundreds of experienced trainers and Service Dog owners who believe
            there should be an opportunity for those who wish to voluntarily and knowingly comply with not only the ADA law,
            but also an additional and specific set of
            ...
            Service Dog Standards goes above and beyond the ADA and the basic foundations of a Public Access Test.
            <br>
            Training and owning a service dog isn’t easy — but it shouldn’t feel like magic or unobtainable either. We strive to offer a way to display and document a Service Dog’s training and adherence to behavioral standards.
          </div>
        </div>
      </div>
    </div>
    ...
    <!--     style="background-color: white; min-height: inherit; padding-bottom: 20px; padding-top: 20px; "-->
    <!--&gt;-->
    <!--   <div class="content-container-sm" >-->

    <!--      <div class="section" v-if="$vuetify.breakpoint.width>750">-->
    <!--         <img src="./images/SDS-Handler-with-Dog-Purple.png" width="366"-->
    <!--              style=" float: right; max-width: 300px; width: 100%">-->
    ...
    <!--         <div>-->
    <!--            <img src="./images/SDS-Handler-with-Dog-Purple.png" width="90%">-->
    <!--         </div>-->
    <!--         <div class="pb-4">-->
    <!--            &lt;!&ndash;<div style="color: var(&#45;&#45;color-headline); font-size: 14pt; font-weight: 600" class="mb-4">&ndash;&gt;-->
    <!--            <div  class="lm-heading mb-4">-->
    <!--               Our purpose is to add clarity to the process and responsibilities of being partnered with a Service Dog.-->
    <!--            </div>-->
    ...
    <div class="content-container-bg">
      <div class="content-container-sm">
        ...
        <div class="section">
          ...
          <p>
            The purpose of Service Dog Standards is to add clarity to the process and responsibilities of being partnered with a Service Dog. At our heart, we encourage adherence to the ADA by requiring our Registrants to understand that intentionally misrepresenting an animal as Service Animal for any reason is not only unethical, it is also in violation of federal and local laws.
          </p>

          <p>
            Service Dog Standards provides trainers and handlers the opportunity to voluntarily hold themselves and their animal accountable to a higher standard by publicly signing a specific set of training and behavior standards that goes above and beyond the law.
          </p>
        ...
        <!--   <div class="lm-heading ">-->
        <!--      Service Dog Standards & Training and Behavior Standards Agreement-->
        <!--   </div>-->
        ...
        <div class="section mb-3">
          <span style="color: #ff6600; font-weight: 500">Warning:</span>
