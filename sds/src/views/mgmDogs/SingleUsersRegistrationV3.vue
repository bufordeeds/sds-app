    ...
    <div class="registration-container" :style="container_style">
        <div class="reg-header">
            ...
            <div style="width:20px; height: 20px; display: flex; justify-content: center; align-items: center; cursor: pointer"
                ...
                <v-icon v-if="expanded_loc" color="white">
                    remove
                </v-icon>
        ...
        <div v-if="expanded_loc" class="reg-body">
            <!--------full sized table-------------------------------------------------------------------------->
            <table v-if="!isMobile" style="width: 100%">
                <tbody>
                    ...
                    <tr v-for="(item, ix) in dogs" :key="item._id + ix">
                        ...
                        <td class="col-service-dog" style="display: flex; justify-content: center;">
                            ...
                            <div style="display: flex; justify-content: space-evenly; width: 100%">
                                ...
                                <div style="display: flex; flex-direction: column; align-items: center; cursor: pointer;"
                                    ...
                                    <avatar :image="item.profile_image" size="50" profile-type="dog" :rounded="true" />
                                ...
                                <div style="height: 100%">
                                    ...
                                    <div v-if="item.handler_id_FR == null"
                                        ...
                                        <v-btn small @click="$emit('show-add-handler', { dog: item })">
                                            Invite Handler
                                        </v-btn>
                                    </div>
                                    ...
                                    <div v-else style="display: flex; flex-direction: column; align-items: center">
                                        <avatar :image="item.handler_id_FR.profile_image" :rounded="true" size="50" />
                                        ...
                                        <v-btn v-if="myDogs && isHandler" text x-small style="padding-top: 0px"
                                            to="/manageProfile">
                                            <div style="font-size: 9pt; cursor: pointer;">
                                                Edit
                                            </div>
                                        ...
                                        <div v-if="item.confirmed_handler === false" style="font-size: 9pt; ">
                        ...
                        <td style=" padding-left: 10px; ">
                            <div>
                                <router-link v-if="isHandler" :to="'/team/' + item.dog_num">
                            ...
                            <div v-if="item.registration_kit == null">
                                ...
                                <div style="display: flex; justify-content: center; padding-top: 10px;">
                                    <v-btn v-if="item.handler_id != null && item.confirmed_handler !== false" small
                            ...
                            <div v-else>
                                ...
                                <div style="display: flex; justify-content: center; padding-top: 10px;">
                                    <v-btn small color="var(--color-btn)" class="white--text"
                                        @click="$emit('show-add-dog-cart', { dog: item })">
                                        Reorder Items
                                    </v-btn>
                                </div>
                        ...
                        <td class="col-service-do-reg">
                            ...
                            <div style="display: flex; justify-content: center">
                                ...
                                <div v-else style="display: flex">
                                    <avatar :image="item.trainer_id_FR.profile_image" :rounded="true" size="75"
                                        size-no-image="50" />
                        ...
                        <td class="col-service-do-reg">
                            <div style="display: flex; justify-content: center" class="pt-2">
                                <status v-model="item.status" style="width: 180px;"
            ...
            <!------------------------------------------------------------------------------------------------------------>
            <div v-else>
                <div v-if="myDogs" style="display: flex; justify-content: center" class="mb-3">
                    <avatar :image="user.profile_image" size="85" profile-type="user" :rounded="true" />

                    <div class="ml-4">
                        <div class="dog-row-header" style=" margin-bottom: 15px; margin-top: 10px">
                            <!--{{$auth.profile.name_first}}-->
                            <v-btn to="/manageProfile">
                                Update Info
                            </v-btn>
                        </div>
                    </div>
                ...
                <div v-for="(item, ix) in dogs" :key="item._id + ix" class="dog-row ">
                    ...
                    <div class="dog-row-section">
                        <div style="display: flex; flex-wrap: wrap; justify-content: center">
                            <div style="display: flex; flex-direction: column; align-items: center">
                                <avatar :image="item.profile_image" size="85" profile-type="dog" :rounded="true" />
                            ...
                            <div class="ml-4">
                                ...
                                <status v-if="$vuetify.breakpoint.width > 400" v-model="item.status"
                                    style="width: 190px; max-width: 80%" @input="save_dog_status(item._id, $event)" />
                            </div>
                        </div>
                    ...
                    <!------------handler section------------>
                    <div v-if="$auth.profile.user_id !== item.handler_id" class="dog-row-section">
                        ...
                        <template v-else>
                            <div style="display: flex">
                                <avatar :image="item.handler_id_FR.profile_image" :rounded="true" size="75"
                                    size-no-image="50" />
                    ...
                    <div class="dog-row-section">
                        <div style="display: flex; justify-content: center; width: 100%; max-width: 400px; flex-wrap: wrap">
                            <v-btn class="ml-2 mr-2 mt-3" to="/accountHome" width="170px">
                                Renew Agreement
                            </v-btn>


                            <div class="ml-2 mr-2 mt-3">
                                <v-btn v-if="item.registration_kit == null" color="#8fc64b" class="white--text"
                                    width="170px" @click="$emit('show-add-dog-cart', { dog: item })">
                                    Order Items
                                </v-btn>


                                <v-btn v-else color="#8fc64b" class="white--text" width="170px"
                                    @click="$emit('show-add-dog-cart', { dog: item })">
                                    Reorder Items
                                </v-btn>
                            </div>
            ...
            <div v-if="showAddDogs" style="display:flex; justify-content: flex-end; align-items: center" class="pa-2">
                <span class="pr-2 pt-1">
                    Add Service Dog
                </span>
                <v-btn rounded small color="var(--color-btn)" @click="$emit('show-add-dog')">
                    <v-icon color="white">
                        add
                    </v-icon>
                </v-btn>
