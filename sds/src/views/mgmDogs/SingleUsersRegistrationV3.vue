          ...
          <div  v-for="(item, ix) in dogs" :key="item._id + ix" class="dog-row ">
             ...
             <div class="dog-row-section" >
                <div style="display: flex; flex-wrap: wrap; justify-content: center">
                   <div style="display: flex; flex-direction: column; align-items: center">
                      ...
                      <v-btn text x-small style="padding-top: 0px" @click="$emit('show-edit-dog', {user:user, dog:item})">
                         <div style="font-size: 9pt; cursor: pointer;">
                            Edit
                         </div>
                      </v-btn>
                ...
                <status v-if="$vuetify.breakpoint.width <= 400"
                    v-model="item.status" @input="save_dog_status(item._id, $event)"
             ...
             <div class="dog-row-section" >
                ...
                <div style="display: flex; justify-content: center; width: 100%; max-width: 400px; flex-wrap: wrap">
                   ...
                   <v-btn class="ml-2 mr-2 mt-3" to="/accountHome"
                          width="170px"
                   >
                      Renew Agreement
                   </v-btn>
