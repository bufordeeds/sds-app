<template>
    <div class="registration-container" :style="container_style">
        <div class="reg-header">
            ...
            <avatar v-if="isHandler" class="ml-3" :image="user.profile_image" size="25" :rounded="true" />


            <div style="padding-left: 10px; color: var(--color-subheading); font-size: 12pt; font-weight: 500">
                {{ user.name_first }} {{ user.name_last }}
                <span v-if="user.account_status && user.account_status.date_expiry == null">(Waiting on user to sign
                    up)</span>
            </div>
            <v-spacer />
        </div>
                        ...
                        <div style="display: flex; justify-content: center; width: 100%;  flex-wrap: wrap">
                            ...
                            <div class="ml-2 mr-2 mt-3">
                                <v-btn v-if="item.registration_kit == null" color="#8fc64b" class="white--text"
                                    width="170px" @click="$emit('show-add-dog-cart', { dog: item, isReorder: false })">
                                    Order Items
                                </v-btn>
                            ...
                            <v-btn v-if="showTransfer" class="ml-2 mr-2 mt-3" width="170px"
...
import status from '@/components/inputs/StatusDropDown.vue';
...
export default {
    name: "SingleUsersRegistrationV4",
