         ...
         <v-form ref="form" @submit.prevent>
            <v-container>
               ...
               <v-row justify="end" class="ma-0 pt-9">
                  ...
                  <v-btn v-if="areEditing" @click="update_access" color="var(--color-primary)" > Update </v-btn>
                  <v-btn v-else @click="update_access" color="var(--color-primary)" :disabled="!user_active" > Give Access </v-btn>
