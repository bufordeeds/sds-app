    ...
    >
      <v-card class="pt-5">
        ...
        <v-card-actions
          ...
          class="mt-3"
        >
          <v-btn @click="show_addr_warning=false">
            Update Address
          </v-btn>
          <v-spacer />
        ...
        <div
          v-else
          class="centered-flex-column pt-3 pb-3"
        >
          <v-btn @click="show_addr_warning=false">
            Update Address
          </v-btn>
      ...
      <v-container style="max-width: 700px;">
        ...
        <div v-if="isTrainer">
          ...
          <div>
            ...
            <v-tooltip bottom>
              <template #activator="{ on, attrs }">
                <span
                  style="font-size: 9pt; margin-left: 7px;"
                  v-bind="attrs"
                  v-on="on"
                >
                  What is this
          ...
          >
            ...
            <div
              v-if="public_info.will_travel"
              style="width: 100%; padding-left: 30px; margin-top: -15px; padding-bottom: 10px"
            >
              <sds-input
          ...
          <v-tooltip
            ...
            left
            nudge-bottom="20"
            content-class="my-tooltip-class"
          >
