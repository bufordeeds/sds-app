      ...
      <table style="width: 100%">
        ...
        <tbody>
          ...
          <template v-for="(item, ix) in users">
            <tr :key="item.user._id" style="cursor: pointer" @click="on_click_user(item.user, ix)">
              <td class="col-service-dog">
                <div class="sd-name-container">
                  <img v-if="!item.user.profile_image" src="../../assets/images/content/user-no-image.png" width="75px">
            ...
            <tr :key="item.user._id + 'dog'">
              <td colspan="4">
                <table style="width: 100%; margin-left: 20px">
                  <tr v-for="dog in item.user.dogs" :key="dog._id" style="cursor: pointer" @click="on_click_dog(dog)">
                    <td>
