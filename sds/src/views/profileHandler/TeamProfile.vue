<template>
   <div>
      ...
      <v-dialog v-model="show_overlay" max-width="600" persistent>
         <div style="background-color: white" class="pa-6">
            ...
            <p>
               ...
               <router-link to="/faq">Service Dog Standards</router-link>
               and agree to our
               <router-link to="/terms-access-use">Terms of Access and Use</router-link>.
      ...
      <div v-if="edit_mode" style="display: flex; justify-content: center">
      ...
      <div class="content-container-bg" :style="{'background-image': `url(${require('../../assets/images/content/SDSProfilePageBackground.png')})`, 'background-size': $vuetify.breakpoint.width>800?'contain':'200%'}"
           style=" background-position: top;"
      >

         <div class="content-container-centered" v-if="dog._id == null" style="text-align: center; font-size: 14pt">
            Oops can't seem to find this profile.
            The user may have set their profile to private.
         </div>

         <div class="content-container-centered" v-if="dog._id != null" style="max-width: 500px">
            ...
            <div v-if="edit_mode" class="centered-flex-column">
               <v-btn
                      @click="show_upload_image=true" text color="var(--color-btn)">
                  Edit Photo
               </v-btn>
            </div>

            <!------------------------ main content  container ------------------->
            <div class="main-content" style="margin-top: -50px; padding-top: 10px; padding-bottom: 100px;">
               ...
               <div class="centered-content" style="margin-top: 35px">
                  <span class="pr-1">Pet me!</span>
                  <v-btn icon dark @click="pet_dog" :disabled="edit_mode">
                     <img src="../../assets/images/icons/like2.png" height="30" >
                  </v-btn>
               ...
               <div v-if="$vuetify.breakpoint.width >400"
                   class="centered-content" style="margin-top: -50px; margin-bottom: -60px;">
                  <line-animation2 />
               </div>


               <div v-else
                   class="centered-content" style="margin-top: -30px; margin-bottom: -40px;">
                  <line-animation2 />
               </div>


               <div class="centered-content" style="flex-direction: column; text-align: center">
                  ...
                  <div v-else style="font-size: small; margin-top: 0px">
                     Screen shots are not valid <br>
                     Verify
                     <a href="https://servicedogstandards.org">servicedogstandards.org</a> URL <br>
                     Colored lines must be moving
            ...
            <!------------------------ about the standard ------------------->
            <div class="main-content" style="margin-top: 20px; padding-top: 20px; padding-bottom: 40px">
               ...
               <div class="centered-content" >
                  <learn-more-btn :size="15" to="/learn-more/mission"  />
               </div>
            ...
            <!------------------------ Trainer info  ------------------->
            <div class="main-content" style="margin-top: 20px; padding-top: 20px; padding-bottom: 40px" v-if="dog.trainer_id_FR || dog.chip_number || dog.coat_color">
            ...
            >
               <template v-slot:expand_content>
            ...
            >
               <template v-slot:expand_content>
                  <div class="modal-expanded">
                     ...
                     <div>
                        <learn-more-btn :size="12" no-padding to="/faq/license_test_for_service_dog"/>
                     </div>
                  </div>
               </template>
            </team-modal>
            ...
            >
               <template v-slot:expand_content>
                  <div class="modal-expanded">
                     ...
                     <div>
                        <learn-more-btn :size="12" no-padding to="/faq/public_access_test"/>
                     </div>
            ...
            >
               <template v-slot:expand_content>
                  <div class="modal-expanded">
                     ...
                     <div>
                        <learn-more-btn :size="12" no-padding to="/faq/doctors_letter"/>
                     </div>
                  </div>
               </template>
