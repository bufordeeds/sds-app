<template>
   <div>
      ...
      <div class="content-container-bg" style="min-height: calc(100vh - 284px)" v-if="user._id == null">
      ...
      <div class="content-container-bg" style="min-height: calc(100vh - 284px)" v-if="user._id != null">
         ...
         <div v-if="edit_mode"  class="mb-4 centered-flex-column" style="background-color: inherit">
         ...
         <div class="profile-container" style="background-color: white;">
            ...
            <div class="header-container">
               ...
               <div class="mr-2" >
                  ...
                  <v-avatar size="100">
                     ...
                     >
                     <img v-else :src="user.profile_image.Location" width="75px">
                  </v-avatar>



                  <div v-if="edit_mode"
                       style="text-align: center; color: var(--color-subheading); font-size: 10pt" class="mt-1"
                       @click="$emit('edit-profile-pic')"
                  >
                     <v-btn v-if="edit_mode"
                            text small color="var(--color-subheading)" style="margin-top: -10px">
               ...
               <div class="trainer-info">
                  ...
                  <div style="margin-top:-10px; margin-bottom: -5px">
                     <img src="../../assets/images/content/SDSTrainerLogo.svg" height="16" >
                  </div>

                  <div>
                     <span style="color: var(--color-headline); font-size: 14pt; font-weight: 500;" class="mb-1">
                        {{user.name_first}} {{user.name_last}}
                     </span>   Trainer
                  </div>
                  <div style="font-size:20pt; color: var(--color-headline); font-weight: 700; line-height: 1.2; ">
                     {{trainer_info.business_name}}
                  </div>
                  <div style="font-size:14pt; color: var(--color-headline); font-weight: 600; line-height: 1.2;">
                     {{trainer_info.tagline}}
                  </div>

                  <div class="city-state" v-if="$vuetify.breakpoint.width<=900">
                     {{addr_city_state}}
                  </div>
            ...
            <div class="banner-photo" :style="banner_style" >
               ...
               >
                  <v-btn text class="white--text mr-4" @click="$emit('upload-banner')">
                     <img src="../../assets/images/icons/camera-white.png" height="20px" class="pr-1">
                     Customize Photo
                  </v-btn>

               </div>

               <img v-if="banner_src" :src="banner_src"  style="max-height: 400px; width: 100%; display:block;">
            ...
            <div class="contact-container">
               ...
               <div class="contact-column">
                  <template v-if="show_biz_address">
                     ...
                     <div style="font-weight: 500; " >
                        <a :href="google_link" style="color:var(--color-headline)" target="_blank">
                           {{address.street1}} <br v-if="address.street1">
                  ...
                  <div v-if="user.trainer_info.will_travel || user.trainer_info.will_transport || user.trainer_info.have_facility" class="mt-4">
                     ...
                     <div v-if="user.trainer_info.will_travel">
                        ...
                        <template v-if="isFinite(user.trainer_info.max_travel_miles)">
                           up to {{Math.round(user.trainer_info.max_travel_miles)}} miles
                        </template>
               ...
               <div class="contact-column" :style="{'margin-top': $vuetify.breakpoint.xs ? '10px': '0'  }">
                  ...
                  <div class="contact-header" v-if="user.trainer_info.phone != null || user.email != null || user.trainer_info.website != null">
                     Contact
                  </div>


                  <div class="mt-1" v-if="user.trainer_info.phone != null ">
                     <a :href="'tel:'+user.trainer_info.phone" class="click-to-call">
                        <span style="color: var(--color-heading-grey)">Phone: </span> <span class="contact-value">
                  ...
                  <div class="mt-1" v-if="user.trainer_info.website">
                     Web:
                     <a :href="cleaned_url(user.trainer_info.website)" target="_blank">
                        <span class="contact-value">{{user.trainer_info.website}}</span>
                     </a>
                  </div>
         ...
         <div class="profile-container" style="display: flex" v-if="show_two_col">
            <!--  two column layout-->
            ...
            <div class="column">
               ...
               <template v-for="section in sections.col1">
                  ...
                  >
                     ...
                     <template v-slot:content v-if="section.content || section.heading">
                        <div class="section-header" v-if="section.heading">
                           {{section.heading}}
                        </div>

                        <div style="white-space: pre-line;" v-if="section.content">
                           {{section.content}}
                        </div>
                     </template>
                  </info-section>
                  ...
                  <div v-if="edit_mode" class="section-edit-container" :key="section.label+'edit'">
                     <v-spacer></v-spacer>
                        ...
                        <div style="margin-top: -10px;"  v-if="showNA(section)">
                           ...
                           <v-checkbox
                              ...
                              label="Section is N/A"
                               ...
                               @change="on_section_check(section.edit_event, section.skip)"
                           />
            ...
            <div class="column">
               ...
               <div v-if="edit_mode" class="section-edit-container">
                  <v-btn text small color="blue" @click="$emit('edit-section', 'caption' )">
                     <i class="material-icons section-edit-icon">create</i>
                     Edit Caption
                  </v-btn>
                  <v-spacer></v-spacer>
                  <v-btn text small color="blue" @click="$emit('edit-gallery', )">
                     <i class="material-icons section-edit-icon">create</i>
                     Add Images
                  </v-btn>
               </div>
         ...
         <div class="profile-container" style="display: flex" v-else> <!-- if part is the two column layout-->
            ...
            <div class="single-column">
               ...
               <template v-for="section in sections.col1">
                  ...
                  <div v-if="edit_mode" class="section-edit-container" :key="section.label+'edit'" style="width: 100%;">
                     <v-spacer></v-spacer>
                     <!--<v-btn text small color="blue" @click="$emit('edit-section', section.edit_event)">-->
                     <!--   <i class="material-icons section-edit-icon">create</i>-->
                     <!--   Edit-->
...
export default {
   ...
   props: {
      user_id: String,
      user_obj: {type: Object, default: ()=> {return {address:{}, trainer_info:{address:{}}} }  },
   },
   data(){
      return {
         user: this.user_obj,
   ...
   computed:{
      ...
      sections(){
         ...
         if ((this.trainer_info.about != null && this.trainer_info.about != '') || this.edit_mode){
            sections.push({
               label: 'About', color: '#8dc63f', content: this.trainer_info.about,
               icon: require('../../assets/images/icons/About.svg'),
               edit_event: 'about',
               skip: _.get(this.trainer_info, 'section_skip_checks.about', false),
            });
         }

         if (this.list_services.length > 0 || this.edit_mode){
            sections.push({
               label: 'Services', color: '#bf1e2e', list: this.list_services,
               icon: require('../../assets/images/icons/Services.svg'),
               heading: "Types of Service Dogs we Train",
               edit_event: 'services',
               skip: _.get(this.trainer_info, 'section_skip_checks.services', false),
            });
         }
         ...
         if (this.list_certs.length > 0 || this.edit_mode){
            sections.push( {
               label: 'Certifications', color: '#5fafe1', list: this.list_certs,
               icon: require('../../assets/images/icons/Certifications.svg'),
               edit_event: 'certifications',
               skip: _.get(this.trainer_info, 'section_skip_checks.certifications', false),
         ...
         if (this.list_awards.length > 0 || this.edit_mode){
            sections.push( {
               label: 'Honors', color: '#fcb040', list: this.list_awards,
               icon: require('../../assets/images/icons/Awards.svg'),
               edit_event: 'awards',
               skip: _.get(this.trainer_info, 'section_skip_checks.awards', false),
            });
         }
         ...
         if (this.list_groups.length > 0 || this.edit_mode){
            sections.push({
               label: 'Memberships', color: '#f05fa3', list: this.list_groups,
               icon: require('../../assets/images/icons/FollowUs.svg'),
               edit_event: 'groups',
               skip: _.get(this.trainer_info, 'section_skip_checks.groups', false),
            });
         }

         if (this.list_social.length > 0 || this.edit_mode){
            sections.push({
               label: 'Follow Us', color: '#662d91', list: this.list_social,
               icon: require('../../assets/images/icons/group.png'),
               heading: "Friend, find, or follow us!",
               edit_event: 'social',
               skip: _.get(this.trainer_info, 'section_skip_checks.social', false),
            });
         }
      ...
      // google_src(){
      //    let ans = 'https://www.google.com/maps/embed/v1/place?key=AIzaSyBvwfNlgnGeQzSd2eUmnbXSQRE5FCPxhqc'
      //    let address = this.user.address1 + ', ' + this.user.city + ', ' + this.user.state + ', ' + this.user.zip;
      //
      ...
      banner_src(){
         ...
         let ans = null;
         if (this.user){
            let source = _.get(this.user, 'trainer_info.banner_image.Location', null);
            if (source){
   ...
   methods: {
      ...
      async get_profile(){
         try{
            ...
            if (this.$auth.isAuthenticated() && this.$auth.profile.user_id === this.user_id && this.$route.name === 'ManageProfile'){
               ...
               this.user = await this.make_request('/public/getTrainerProfile', {user_id});
               console.log(user_id)
