         ...
         <div class="profile-container">
            ...
            <div class="header-container">
               ...
               <div class="trainer-info">
                  ...
                  <div v-else>
                     <div style="color: var(--color-headline); font-size: 14pt; font-weight: 500;" class="mb-1">
                        {{user.name_first}} {{user.name_last}}
                     </div>
                     <div  style="color: var(--color-headline); font-size: 12pt; font-weight: 400;" class="mb-1">
                        <span v-if="isHandler">
                           Handler
                        </span>
            ...
            <div class="banner-photo" :style="banner_style" >
               ...
               >
                  <v-btn text class="white--text mr-4" @click="$emit('upload-banner', user.account_type)">
               ...
               <img v-if="banner_src" :src="banner_src" width="100%" style="max-height: 400px; display:block;">
            ...
            <div class="contact-container" v-if="isTrainer">
               ...
               <div class="contact-column">
                  ...
                  <div class="mt-1">
                     Web:
                     <a :href="public_info.website" target="_blank">
         ...
         <div class="profile-container-sections">
            ...
            <div class="column">
               ...
               >
                  <template v-slot:icon>
                     <img src="../../assets/images/icons/information-button.svg" width="40%">
                     About
                  </template>
               ...
               <div v-if="edit_mode" class="section-edit-container">
                  <v-spacer></v-spacer>
                  <v-btn text small color="blue" @click="$emit('edit-section', 'about')">
                     <i class="material-icons section-edit-icon">create</i>
                     Edit
                  </v-btn>
               ...
               <div v-if="isTrainer">
                  ...
                  >
                     <template v-slot:icon>
                        <img src="../../assets/images/icons/cross_white.png" width="50%">
                        Training<br>Offered
                     </template>
                  ...
                  <div v-if="edit_mode" class="section-edit-container">
                     <v-spacer></v-spacer>
                     <v-btn text small color="blue" @click="$emit('edit-section', 'services')">
                        <i class="material-icons section-edit-icon">create</i>
                        Edit
                     </v-btn>
                  </div>
               ...
               <div v-if="isTrainer">
                  ...
                  >
                     <template v-slot:icon>
                        <img src="../../assets/images/icons/star.png" width="50%">
                  ...
                  <div v-if="edit_mode" class="section-edit-container">
                     <v-spacer></v-spacer>
                     <v-btn text small color="blue" @click="$emit('edit-section', 'certifications')">
                        <i class="material-icons section-edit-icon">create</i>
                        Edit
                     </v-btn>
                  </div>
               ...
               <div v-if="isTrainer">
                  ...
                  >
                     <template v-slot:icon>
                        <img src="../../assets/images/icons/trophy.png" width="50%">
                  ...
                  <div v-if="edit_mode" class="section-edit-container">
                     <v-spacer></v-spacer>
                     <v-btn text small color="blue" @click="$emit('edit-section', 'awards')">
                        <i class="material-icons section-edit-icon">create</i>
                        Edit
                     </v-btn>
                  </div>
               ...
               <div v-if="isTrainer">
                  ...
                  >
                     <template v-slot:icon>
                        <img src="../../assets/images/icons/paw.png" width="50%">
                        Breeds
                     </template>
                  ...
                  <div v-if="edit_mode" class="section-edit-container">
                     <v-spacer></v-spacer>
                     <v-btn text small color="blue" @click="$emit('edit-section', 'breeds')">
                        <i class="material-icons section-edit-icon">create</i>
                        Edit
                     </v-btn>
                  </div>
            ...
            <div class="column">
               ...
               <div v-if="isTrainer">
                  ...
                  >
                     <template v-slot:icon>
                        <img src="../../assets/images/icons/globe.png" width="50%">
                  ...
                  <div v-if="edit_mode" class="section-edit-container">
                     <v-spacer></v-spacer>
                     <v-btn text small color="blue" @click="$emit('edit-section', 'groups')">
                        <i class="material-icons section-edit-icon">create</i>
                        Edit
                     </v-btn>
                  </div>
               ...
               >
                  <template v-slot:icon>
                     <img src="../../assets/images/icons/group.png" width="50%">
                     Social Center
                  </template>
               ...
               <div v-if="edit_mode" class="section-edit-container">
                  <v-spacer></v-spacer>
                  <v-btn text small color="blue" @click="$emit('edit-section', 'social')">
                     <i class="material-icons section-edit-icon">create</i>
                     Edit
                  </v-btn>
               </div>
