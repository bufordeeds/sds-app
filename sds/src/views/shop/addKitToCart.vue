...
<!--      @uploaded=""-->
      ...
      <div class="sds-content-container-bg">
         <div class="sds-content-container">
            ...
            <!------------------------------ show user's dogs ------------------------------------------->
            <div  style="margin-top: 25px;" v-if="false">
               ...
               <div  class="reg-body">
                  ...
                  <!----------------------- Full screen version -------------------------------->
                  <table v-if="!isMobile"
                      style="width: 100%" class="reg-table">
<!--                     <colgroup>-->
...
<!--                     </colgroup>-->
                  ...
                  <div v-if="isMobile">
                     ...
                     <div class="dog-row-section" >
                        ...
                        <!------------trainer section------------>
                        <div class="dog-row-section" v-if="dog.trainer_id_FR">
            ...
            <!-------------------------- Order Details ------------------------------------------------------>
            <div  style="margin-top: 25px;" class="reg-body pa-4">
               ...
               <div style="display: flex; justify-content: center; " class="mt-1">
                  <div  style="display: flex; justify-content: center; flex-direction: column; align-items: flex-start">
                     ...
                     <div>
                        ...
                        <v-tooltip right>
                           <template v-slot:activator="{ on, attrs }">
                              <span>
                              Expiration<v-icon v-bind="attrs" v-on="on" small>
                                 help_outline
                              </v-icon>:
                              </span>
                        ...
                        <span class="order-detail" v-if="item.details.expiration != null">
                     ...
                     <table class="mt-1" v-if="!isMobile">
                        <tr>
                           <td class="order-label">Service Dog:</td>
                           <td class="order-detail">
                              {{ item.details.dog_name }}
                           </td>
                           <td style="width:20px"></td>

                           <td class="order-label">Handler:</td>
                           <td class="order-detail">
                        ...
                        <tr>
                           ...
                           <td class="order-label">Trainer:</td>
                           <td class="order-detail">
                              {{ item.details.trainer_name }}
                           </td>
                           <td style="width:20px"></td>
                           <td class="order-label">Aide:</td>
                           <td class="order-detail">
            ...
            <!----------------- add training aid ------------------------------------->
            <div class="sds-content-container mt-5 pa-3" style="text-align: center; background-color: white">
               <div class="sds-subtitle" style="color: var(--color-headline)">
               ...
               <v-btn dark color="var(--color-btn)" style="border-radius: 0px" class="pl-8 pr-8"
               @click="edit_item_fn">
                  Edit info
               </v-btn>
...
<!--               </div>-->
               ...
               <div v-if="item.details.kit_image" style="display:flex; flex-direction: column; align-items: center">
                  <img
                       :src="item.details.kit_image.Location"
                       style="max-height:200px"
                  >
                  <v-btn
                      style="border-radius: 0px" class="pl-8 pr-8 mt-4"
                      dark color="var(--color-btn)"
                      @click="remove_image">
                     Remove Image
                  </v-btn>
               ...
               <v-btn v-if="item.details.kit_image == null"
                   dark color="var(--color-btn)" style="border-radius: 0px" class="pl-8 pr-8"
            ...
            <!----------------- Total Cost ----------------------------------------->
            <div class="sds-content-container mt-5 pa-3" style="display: flex; background-color: white; font-weight: 600">
               Item Total
            ...
            <!------------ add to cart button ---------------------------------------------->
            <div class="sds-content-container mt-7 pa-0" style="display: flex; justify-content: center" >


               <template  v-if="cart_ix != null">
                  <v-btn
                      color="grey" style="height: 40px" @click="$emit('close')">
                     Cancel
                  </v-btn>

                  <v-btn
                      class="ml-2 " style="height: 40px" @click="save_cart_item_changes"
                  >
                     Save Changes
                  </v-btn>
               </template>
               ...
               <v-btn
                   v-else
                   dark
                   class="ma-0 " style="width: 100%; height: 40px" @click="add_to_cart"
                   :disabled="!isValid"
                   color="var(--color-btn)"
               >
                  Add to cart
