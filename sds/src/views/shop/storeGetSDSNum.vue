  ...
  <div>
    <div class="sds-content-container-bg">
      <div class="sds-content-container" style="display: flex; flex-direction: column; align-items: center">
        <div class="sds-subtitle" :style="$vuetify.breakpoint.smAndDown ? 'font-size: 15pt' : ''"
          style="text-align: center">
          Customize your materials
        </div>
        <img src="../../assets/images/products/SDSProductPackage.png" style="max-width: 750px; width: 90%">
        ...
        <div v-if="!show_dogs" style="display: flex; flex-direction: column; align-items: center">
          <div style="color: var(--color-subheading); margin-top: 30px; font-weight: 600">
            Enter SDS Number
          </div>

          <my-form ref="form" style="display: flex; justify-content: center">
            <!--<text-input-->
            ...
            <v-menu v-model="show_dog_list" bottom nudge-bottom="50px" :disabled="dogs.length == 0">
              <template #activator="props">
                <div v-on="props.on">
                  <text-input v-model="sds_number" style="max-width: 250px; margin-top: 10px" label="SDS Number"
                    hide-label-on-input border-color="var(--color-primary)" :rules="[isRequired]" />
                </div>
              </template>

              <dog-list :dogs="dogs" @click="sds_number = 'SDS-' + $event" />
            </v-menu>
          </my-form>


          <div
            style="color: var(--color-subheading); margin-top: 5px; font-weight: 600; font-size: 8pt; display: flex; justify-content: center; max-width: 250px; width: 100%">
            ...
            <v-btn x-small to="/manageServiceDogs">
              View All Dogs
            </v-btn>
          </div>
          ...
          <!--            arrow button 2-->
          <v-btn dark text class="ma-0 pa-0" style="height: 40px" @click="get_dog">
            <div
              style="background-color: var(--color-btn); height: 40px; display: flex; justify-content: center; align-items: center; width: 170px">
              Continue
            </div>
            ...
            <table style="width: 100%">
              ...
              <tbody>
                ...
                <tr v-for="(item, ix) in dogs" :key="item._id">
                  <td>
                    <input v-model="dogs[ix].loc_selected" type="checkbox">
                    {{ item.name }}
                  </td>
