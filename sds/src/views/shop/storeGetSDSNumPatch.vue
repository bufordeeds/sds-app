  ...
  <div>
    <div class="sds-content-container-bg">
      <div class="sds-content-container" style="display: flex; flex-direction: column; align-items: center">
        ...
        <img src="../../assets/images/products/SDSPatch.png" style="max-width: 300px; width: 90%; margin-top: 20px">
        ...
        <div v-if="!show_dogs" style="display: flex; flex-direction: column; align-items: center">
          ...
          <div
            style="color: var(--color-subheading); margin-top: 5px; font-weight: 600; font-size: 8pt; display: flex; justify-content: space-between; max-width: 250px">
            <router-link to="/?advanced_search=true" target="_blank">
              Find SDS number
            </router-link>


            <router-link v-if="$auth.authenticated" to="/manageServiceDogs">
              My Service Dogs
            </router-link>
          </div>
